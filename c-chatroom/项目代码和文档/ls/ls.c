...
void paixu(char **s,int l)
{
	...
	for(j=0;j<l-i-1;j++)
	    ...
	    if(s[j][0]<='Z' &&s[j][0]>='A')
	    {
		flag1=1;s[j][0]=s[j][0]+32;
	    }
	    if(s[j+1][0]<='Z' &&s[j+1][0]>='A')
	    {
		flag2=1;s[j+1][0]=s[j+1][0]+32;
	    }
...
void my_printf(char s[500])
{
    ...
    else if(panduanmulu(s)=='-')
	printf("\033[36m %s\033[0m",s);
    else if(panduanmulu(s)=='d')
	printf("\033[38m %s\033[0m",s);
    else if(panduanmulu(s)=='c')
	printf("\033[33m %s\033[0m",s);
    else if(panduanmulu(s)=='b')
	printf("\033[37m %s\033[0m",s);
    else if(panduanmulu(s)=='f')
	printf("\033[31m %s\033[0m",s);
    else if(panduanmulu(s)=='s')
